...
public class ModificarDatos extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        //variables auxiliares para pasar como parametros al metodo guardar(), pero lo puedo hacer directo
        //Datos de la mascota
        ...
        control.modificarMAscota(masco, nombreMasco, raza, color, observaciones, alergico, atEsp, nombreDuenio, celDuenio);
        
        //mensaje todo salio ok
        mostrarMensaje("Edición realizada correctamente", "Info", "Edición Correcta");
        
        //llamo a la pantalla de ver Datos que va a tener los datos actualizados (porque la cerré cuando llamé a la ventana editar)
