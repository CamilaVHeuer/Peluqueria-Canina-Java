...
public class CargaDatos extends javax.swing.JFrame {
        ...
        private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnGuardarActionPerformed
                ...
                String nombreMasco = UtilidadesIGU.convertirATitulo(txtNombre.getText().trim());
                String raza = UtilidadesIGU.convertirATitulo(txtRaza.getText().trim());
                String color = UtilidadesIGU.convertirATitulo(txtColor.getText().trim());
                String observaciones = UtilidadesIGU.convertirAOracion(txtObservaciones.getText().trim()); // Solo
                                                                                                           // primera
                                                                                                           // letra
                String nombreDuenio = UtilidadesIGU.convertirATitulo(txtNomDuenio.getText().trim());
                ...
                // mensaje de confirmacion usando utilidad directamente
                UtilidadesIGU.mostrarMensaje(this, "Se guardó correctamente", "Info", "Guardado exitoso");
