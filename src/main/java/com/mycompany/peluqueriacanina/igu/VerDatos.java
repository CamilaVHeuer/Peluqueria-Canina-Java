...
public class VerDatos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnEditar.setIcon(new javax.swing.ImageIcon("/home/pabloszuban/Imágenes/Capturas de pantalla/editar.png")); // NOI18N
        btnEditar.setText("Editar");
        btnEditar.addActionListener(this::btnEditarActionPerformed);

        btnEliminar.setIcon(new javax.swing.ImageIcon("/home/pabloszuban/Imágenes/Capturas de pantalla/eliminar.png")); // NOI18N
        btnEliminar.setText("Eliminar");
        btnEliminar.addActionListener(this::btnEliminarActionPerformed);

        btnVolver
                .setIcon(new javax.swing.ImageIcon("/home/pabloszuban/Imágenes/Capturas de pantalla/volverinicio.png")); // NOI18N
        ...
        jPanel2Layout.setHorizontalGroup(
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGap(33, 33, 33)
                                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 612,
                ...
                jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        ...
                                        .addGroup(jPanel2Layout.createSequentialGroup()
                                                .addGap(66, 66, 66)
                                                .addComponent(btnEliminar, javax.swing.GroupLayout.PREFERRED_SIZE, 56,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(36, 36, 36)
                                                .addComponent(btnEditar, javax.swing.GroupLayout.PREFERRED_SIZE, 56,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                                .addGap(37, 37, 37)
                                                .addComponent(btnVolver, javax.swing.GroupLayout.PREFERRED_SIZE, 56,
                                                        javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        if (tablaMascotas.getRowCount() > 0) {
            ...
            if (tablaMascotas.getSelectedRow() != -1) {
                ...
                int num_cliente = Integer
                        .parseInt(String.valueOf(tablaMascotas.getValueAt(tablaMascotas.getSelectedRow(), 0)));

                // Obtener el nombre de la mascota para personalizar el mensaje
                String nombreMascota = String.valueOf(tablaMascotas.getValueAt(tablaMascotas.getSelectedRow(), 1));
                ...
                if (confirmacion == JOptionPane.YES_OPTION) {
                    ...
                    mostrarMensaje("La mascota '" + nombreMascota + "' fue eliminada correctamente", "Info",
                            "Eliminación exitosa");
            ...
            mostrarMensaje("No hay ninguna mascota para eliminar", "Error", "Error al eliminar");
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_btnEditarActionPerformed
        ...
        if (tablaMascotas.getRowCount() > 0) {
            ...
            mostrarMensaje("No hay ninguna mascota para editar", "Error", "Error al editar");
        }
